    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueAndNextBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent") ){
                    ...
                    String verificationCode = codeText.toString();

                    if (verificationCode.equals("")){



                        Toast.makeText(RegistrationActivity.this,"Pleaser write verification code",Toast.LENGTH_LONG).show();
                    }else{
                    ...
                    if (!phoneNumber.equals("")){
                        ...
                        Toast.makeText(RegistrationActivity.this,"Pleaser write phone number",Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
        mCallBacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                Toast.makeText(RegistrationActivity.this, "Code has been sent to you,  please check" ,Toast.LENGTH_LONG).show();
